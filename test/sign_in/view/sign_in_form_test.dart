...
void main() {
  group('SignInForm', () {
    ...
    testWidgets('adds SignInEmailChanged to SignInBloc when email is updated', (
      ...
      verify(() => loginBloc.add(const SignInEmailChanged(email))).called(1);
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        when(
          () => loginBloc.state,
        ).thenReturn(const SignInState(isValid: true));
        ...
        // Check that the button is initially disabled since the consent
