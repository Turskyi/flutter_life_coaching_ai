...
class _RetrofitClient implements RetrofitClient {
  ...
  @override
  Future<GoalsResponse> getGoals(String userId, int? page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId, r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GoalsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'goals',
  ...
  Future<CreatedGoalResponse> createGoal(Goal goal) async {
    ...
    final _options = _setStreamType<CreatedGoalResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'goals',
  ...
  Future<UpdatedGoalResponse> updateGoal(Goal goal) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(goal.toJson());
    final _options = _setStreamType<UpdatedGoalResponse>(
  ...
  Future<DeleteGoalResponse> deleteGoal(Goal goal) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(goal.toJson());
    final _options = _setStreamType<DeleteGoalResponse>(
