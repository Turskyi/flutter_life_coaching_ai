...
class _ExampleGradientBubblesState extends State<ExampleGradientBubbles> {
  ...
  List<Message> _generate(int count, [int? seed]) {
    final Random random = Random(seed);
    return List<Message>.unmodifiable(
      List<Message>.generate(count, (int index) {
        return Message(
  ...
  static final List<String> _exampleData = <String>[
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    'In tempus mauris at velit egestas, sed blandit felis ultrices.',
    'Ut molestie mauris et ligula finibus iaculis.',
    'Sed a tempor ligula.',
    'Test',
    'Phasellus ullamcorper, mi ut imperdiet consequat, nibh augue condimentum '
        'nunc, vitae molestie massa augue nec erat.',
    'Donec scelerisque, erat vel placerat facilisis, eros turpis egestas '
        'nulla, a sodales elit nibh et enim.',
    'Mauris quis dignissim neque. In a odio leo. Aliquam egestas egestas '
        'tempor. Etiam at tortor metus.',
    'Quisque lacinia imperdiet faucibus.',
    'Proin egestas arcu non nisl laoreet, vitae iaculis enim volutpat. In '
        'vehicula convallis magna.',
    ...
    'Vestibulum scelerisque velit sed augue ultricies, ut vestibulum lorem '
        'luctus.',
